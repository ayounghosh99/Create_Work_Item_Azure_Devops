 ...
 * @param callbackDependencies
 */
export declare function useSubscription<T>(sourceObservable: IObservable<T>, callbackFn: (value: T) => void, callbackDependencies?: unknown[]): void;
/**
 ...
 * @param callbackDependencies
 */
export declare function useDebouncedSubscription<T>(sourceObservable: IObservable<T>, debounceMs: number, callbackFn: (value: T) => void, callbackDependencies?: unknown[]): void;
