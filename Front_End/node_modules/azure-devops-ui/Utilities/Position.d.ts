 ...
 * @param extraSpaceSize Sets the value of how much the container is larger than the window in all directions.
 */
export declare function updateLayout(transformElement: HTMLElement, transformOrigin: IOrigin, anchorOffset?: IOffset, anchorElement?: HTMLElement, anchorOrigin?: IOrigin, anchorPoint?: IPoint, recursionControl?: number, extraSpaceSize?: number): void;
