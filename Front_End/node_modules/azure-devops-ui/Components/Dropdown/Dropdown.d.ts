 ...
 */
export declare function filterTreeItems<T = {}>(items: IListBoxItem<T>[], filterText: string, currentFilteredIndexMap?: number[], filterItem?: (filterText: string, item: IListBoxItem, items: IListBoxItem<T>[]) => boolean | number[]): {
    filteredIndexMap: number[];
    filteredItems: IListBoxItem<T>[];
    filterMatches: any[];
};
