...
var Dropdown = /** @class */ (function (_super) {
    ...
    function Dropdown(props) {
        ...
        _this.renderCallout = function (dropdown, dropdownId, anchorElement, anchorOffset, anchorOrigin, anchorPoint, dropdownOrigin) {
            var _a = _this.props, actions = _a.actions, calloutContentClassName = _a.calloutContentClassName, columns = _a.columns, containerClassName = _a.containerClassName, filterPlaceholderText = _a.filterPlaceholderText, filteredNoResultsText = _a.filteredNoResultsText, getUnselectableRanges = _a.getUnselectableRanges, items = _a.items, loading = _a.loading, noItemsText = _a.noItemsText, renderItem = _a.renderItem, renderBeforeContent = _a.renderBeforeContent, searching = _a.searching, showFilterBox = _a.showFilterBox, showItemsWhileSearching = _a.showItemsWhileSearching, showTree = _a.showTree, userFilteredItems = _a.userFilteredItems;
 ...
 * @returns items matching filter and all their predecessors and descendants in the tree
 */
export function filterTreeItems(items, filterText, currentFilteredIndexMap, filterItem) {
    if (currentFilteredIndexMap === void 0) { currentFilteredIndexMap = []; }
    if (filterItem === void 0) { filterItem = filterItemByText; }
    ...
    return { filteredIndexMap: filteredIndexMap, filteredItems: filteredItems, filterMatches: [] };
}
