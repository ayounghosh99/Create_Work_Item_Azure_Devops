    ...
    HeaderCommandBar.prototype.render = function () {
        ...
        if (items.length > 0) {
            return (React.createElement(CustomHeaderCommandBar, { className: this.props.className, focusGroupProps: { defaultElementId: defaultElementId || this.moreButtonId }, role: isMenuBar ? "menubar" : undefined },
                React.createElement(ResizeGroup, { responsiveLayoutProps: { responsiveChildren: responsiveChildren.reverse() }, overflowMenuItems: overflowItems.reverse(), extraItems: extraItems },
                    React.createElement("div", { className: css(this.props.className, "flex-row flex-center flex-grow scroll-hidden justify-end rhythm-horizontal-8") }, buttonItems))));
        }
        return null;
    };
