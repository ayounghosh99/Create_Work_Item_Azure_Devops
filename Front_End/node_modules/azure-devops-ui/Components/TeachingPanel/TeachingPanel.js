...
var TeachingPanel = /** @class */ (function (_super) {
    ...
    function TeachingPanel(props) {
        ...
        _this._renderPanel = function () {
            ...
            return (React.createElement(Callout, { className: "bolt-teaching-panel-layer", contentClassName: "bolt-teaching-panel depth-16", contentJustification: ContentJustification.Center, contentLocation: ContentLocation.Center, contentOrientation: ContentOrientation.Column, contentShadow: true, escDismiss: true, lightDismiss: true, modal: true, onDismiss: _this._onPanelClose },
