...
export function convertListBoxItemsToTreeItems(items) {
    ...
    for (var _i = 0, items_2 = items; _i < items_2.length; _i++) {
        ...
        var treeItem = {
            ...
            expanded: precreatedTreeItem === null || precreatedTreeItem === void 0 ? void 0 : precreatedTreeItem.expanded,
            data: item,
            id: item.id,
            text: item.text
        };
        if (!item.parent) {
            ...
            if (parent_1) {
                ...
                itemsMap.set(item.parent.id, { childItems: [treeItem], expanded: true });
            }
        }
